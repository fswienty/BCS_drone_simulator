...
# circle swaps time until solution data, 10 runs, mean and std
# x = [2, 3, 4, 5, 6]
...
# x = [2, 4, 6, 8]
# y = [0.2696045398712158, 0.3316895246505737, 0.46469435691833494, 1.0863147258758545]
# std = [0.012899517381508185, 0.013873055261522143, 0.007741864388553333, 0.025682008564961487]
